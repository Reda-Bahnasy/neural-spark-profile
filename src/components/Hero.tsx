  ...
  return <section id="home" className="min-h-screen flex flex-col justify-center relative overflow-hidden">
      ...
      <div className="container-custom text-center">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="text-4xl lg:text-6xl leading-tight animate-fade-in mb-4 mx-0 md:text-2xl font-normal">AI Engineer &amp; Data Analyst</h1>
          
          <p className="text-lg md:text-xl mt-6 text-gray-700 max-w-2xl mx-auto animate-fade-in" style={{
          animationDelay: "0.2s"
        }}>
          ...
          <div className="mt-10 space-x-4 animate-fade-in" style={{
          animationDelay: "0.4s"
        }}>
      ...
      {/* Scroll indicator */}
      <a href="#about" className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex flex-col items-center text-sm text-gray-500 hover:text-[#71C9CE] transition-colors">
